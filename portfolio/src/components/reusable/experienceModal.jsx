...
const Modal = ({ experience, closeModal }) => {
  ...
  return (
    <motion.div
      className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900 bg-opacity-50 text-gray-800  px-24 py-10"
    ...
    >
      ...
      >
        <div className="w-full lg:w-3/4 p-8 relative bg-white ">
          <div>
            <h3 className="mb-2 font-semibold text-3xl">
              {t(`experience.${experience.key}.title`)}
            </h3>
            <p className="text-lg text-blue-500 font-semibold mb-6 flex items-center">
              <span className="flex">
                ...
                <div className="mx-5">
                  {files.map((file, index) => (
                    <div key={index} className="mb-2 pb-4">
                      <a
                        href={file}
                        className="text-lg text-gray-800  hover:underline flex items-center"
                        download
                      >
        ...
        <div className="w-full lg:w-1/4 p-8 bg-gray-100  hidden lg:block">
          <div className="mb-8">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 pt-2">
              {technologies.map((technology, index) => (
                <span key={index} className="text-gray-600  text-3xl">
          ...
          <div className="my-8 mt-10 md:hidden lg:block">
            <h3 className="text-xl font-semibold text-gray-800  my-4 md:mt-8">
