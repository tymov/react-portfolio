  ...
  return (
    <div className="inline-block relative w-full">
      <select
        ...
        className="block appearance-none bg-gray-50 dark:bg-slate-900 px-4 py-2 pr-8 rounded-md shadow-sm leading-tight focus:outline-none focus:ring-indigo-500 focus:ring-opacity-50"
      >
        <option value="en">
